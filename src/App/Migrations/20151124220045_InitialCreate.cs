...
// 
//  File:           : 20151124220045_InitialCreate.cs
//  Project         : App
// ******************************************************************************
using System;
...
namespace App.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true, maxLength: 512),
                    EmailConfirmed = table.Column<bool>(nullable: false),
                    GroupId = table.Column<int>(nullable: false),
                    LockoutEnabled = table.Column<bool>(nullable: false),
                    LockoutEnd = table.Column<DateTimeOffset>(nullable: true),
                    NormalizedEmail = table.Column<string>(nullable: true, maxLength: 512),
                    NormalizedUserName = table.Column<string>(nullable: true, maxLength: 512),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    OwnerId = table.Column<int>(nullable: false),
                    Subject = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserTrustedUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserTrustedUser_AppUser_SourceUserId",
                        column: x => x.SourceUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppUserTrustedUser_AppUser_TargetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SheetEntry", x => x.Id);
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable("CalculationOptions");
            migrationBuilder.DropTable("AppUserTrustedUsers");
            migrationBuilder.DropTable("SheetEntry");
            migrationBuilder.DropTable("AspNetRoleClaims");
            migrationBuilder.DropTable("AspNetUserClaims");
            migrationBuilder.DropTable("AspNetUserLogins");
            migrationBuilder.DropTable("AspNetUserRoles");
            migrationBuilder.DropTable("Category");
            migrationBuilder.DropTable("Sheet");
            migrationBuilder.DropTable("AspNetRoles");
            migrationBuilder.DropTable("AspNetUsers");
            migrationBuilder.DropTable("AppOwner");
        }
    }
}
